...
class TestModelBuilder(unittest.TestCase):
    ...
    class TestModelSearch(unittest.TestCase):
        ...
        def test_get_classes(self):
            id_objs = []
            for i in dir(self.builder._identifiers.objects):
                id_objs.append(eval(f'self.builder._identifiers.objects.{i}'))
...
class TestInstanceBuilder(unittest.TestCase):
    ...
    def test_ppi(self):
        self.builder.set_ppi_view()
        graph = self.builder.view

    def test_module(self):
        self.builder.set_module_view()
        graph = self.builder.view
